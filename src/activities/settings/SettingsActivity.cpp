...
void SettingsActivity::render(RenderLock&&) {
  ...
  // conflicts with button hints on non-touch devices. It carries the fork's
  // build number rather than the upstream release: this is the screen reached
  // to check what is installed, and the upstream figure is on the OTA screen.
