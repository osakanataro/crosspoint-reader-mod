...
void EpubReaderMenuActivity::prewarmFrame(UiGlyphPrewarm& warm) {
  ...
  warm.add(UiGlyphPrewarm::Role::ListSmall, tr(STR_CHAPTER_PREFIX));
  warm.add(UiGlyphPrewarm::Role::ListSmall, tr(STR_PAGES_SEPARATOR));
  warm.add(UiGlyphPrewarm::Role::ListSmall, tr(STR_BOOK_PREFIX));
