...
class TextBlock final : public Block {
 ...
 public:
  ...
  // baseline. No focus-split support (bionic reading is horizontal-only). Ruby is
  // accepted for parity with the horizontal constructor, but the vertical renderer
